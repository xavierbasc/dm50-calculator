...
const features = [
  ...
  },
  {
    ...
    tag: 'DEC·BIN·OCT·HEX',
    desc: 'Type a 16-bit value in any base and see it instantly in decimal, binary, octal and hexadecimal — all four shown at once, live.',
  },
  {
    key: 'units',
    icon: '⇌',
    ...
    tag: '5 CATEGORIES',
    desc: 'Length, mass, temperature, volume and speed. Pick a source and target unit and convert instantly — from millimetres to nautical miles.',
  },
  {
    key: 'triangle',
    icon: '△',
    ...
    tag: 'SSS·SAS·ASA',
    desc: 'Give it any 3 known sides or angles and it solves the rest — law of sines and cosines under the hood, plus instant area and perimeter.',
  },
  {
    key: 'dates',
    icon: 'Δ',
    ...
    tag: 'CALENDAR',
    desc: 'Find the day of the week for any date, and the exact number of days between two dates. Accurate Gregorian calendar math.',
  },
  {
    key: 'undo',
    icon: '↺',
    ...
    title: 'Undo / Redo',
    tag: 'BLUE + ⌫',
    desc: 'Made a mistake? Hold BLUE and press Backspace to undo your last entry in CAS or RPN — press it again to redo.',
  },
  {
    key: 'formulas',
    icon: 'ƒ',
    ...
    tag: 'DIAGRAMS',
    desc: 'A pixel-art library of classic equations by category, each with its own hand-drawn diagram. One tap inserts it into your calculation.',
  },
  {
    key: 'eq',
    icon: '=',
