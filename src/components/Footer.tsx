        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="font-mono-retro text-retro-muted text-xs leading-relaxed max-w-xs">
              HP-inspired scientific calculator for Apple, Android, Windows &amp; Linux. Authentic 132×64 LCD, RPN, CAS and much more.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-mono-retro text-retro-muted text-xs mt-3">Apple · Android · Windows · Linux</p>
          </div>
        </div>
