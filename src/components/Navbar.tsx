    ...
    >
      <nav className="max-w-6xl mx-auto px-5 h-14 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-1.5 px-4 py-2 text-xs font-pixel bg-green text-retro-bg hover:bg-green-bright transition-colors duration-150"
      ...
      {menuOpen && (
        <div className="md:hidden bg-retro-surface border-t border-retro-border px-5 py-4 flex flex-col gap-3 font-mono-retro text-sm text-retro-muted">
          ...
          <a
            ...
            className="mt-2 px-4 py-2.5 bg-green text-retro-bg font-pixel text-xs text-center"
          >
            App Store
          </a>
        </div>
